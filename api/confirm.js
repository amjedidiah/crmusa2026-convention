...
export default async function handler(req, res) {
  ...
  const {
    ...
    pledge_code, tier, total_pledged, amount_paid, attendees,
  } = req.body || {};
    ...
    '<tr><td style="padding:32px 40px;">' +
      ...
      '<p style="margin:0 0 24px;font-size:14px;color:rgba(245,239,224,0.65);line-height:1.75;">' +
        ...
        (total === 0
          ...
          : 'Your total is <strong style="color:#E8C87A;">$' + total + '.00</strong>. ' +
            'Please complete your payment via Zelle or Zeffy using the instructions below. ' +
      ...
      '<table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid rgba(200,168,90,0.15);margin-bottom:26px;">' +
        ...
        '<tr style="border-top:1px solid rgba(200,168,90,0.15);">' +
             ...
             '<td style="padding:12px 16px;font-size:20px;color:' + (remaining > 0 ? '#E8C87A' : '#7dbf80') + ';text-align:right;font-family:Georgia,serif;font-weight:bold;">' +
             (remaining > 0 ? '$' + remaining + '.00' : 'Fully Paid') + '</td></tr>' +
      '</table>' +
        ...
        ? '<table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(200,168,90,0.06);border:1px solid rgba(200,168,90,0.2);margin-bottom:24px;">' +
            '<tr><td style="padding:20px 24px;">' +
              ...
              '<p style="margin:0 0 14px;font-size:13px;color:rgba(245,239,224,0.6);line-height:1.8;">' +
                ...
                'Put your pledge code <strong style="color:#E8C87A;letter-spacing:3px;font-family:Courier New,monospace;">' + pledge_code + '</strong> in the Memo/Note field.' +
              '</p>' +
              ...
              '<p style="margin:0 0 16px;font-size:13px;color:rgba(245,239,224,0.6);line-height:1.8;">' +
                ...
                '<strong style="color:#E8C87A;letter-spacing:3px;font-family:Courier New,monospace;">' + pledge_code + '</strong> ' +
  ...
  var notifyHtml =
    ...
    '<table style="background:#fff;border-collapse:collapse;width:100%;max-width:560px;border:1px solid #ddd;">' +
      ...
      notifyRow('Balance Due',   '<span style="color:' + (remaining > 0 ? '#B8860B' : 'green') + ';font-weight:bold;">' +
                                 (remaining > 0 ? '$' + remaining + '.00 outstanding' : 'Fully Paid') + '</span>') +
